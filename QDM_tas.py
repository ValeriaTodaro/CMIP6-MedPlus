"""
This script performs QDM bias correction of CMIP6 mean temperature outputs.
...
def quantile_delta_mapping_one_to_one(obs, modh, modp):
    obs = obs.chunk({obs.dims[0]: -1})  # Chunk along the first axis (time)
    ...
    delta = sorted_modp.values - sorted_modh.values
    corrected = sorted_obs + delta
