"""
This script performs QDM bias correction of CMIP6 maximum temperature outputs.
...
ds_obs[f'{var}_ERA5']=ds_obs_var[f'{var}_ERA5']-ds_obs_mean[f'{var_mean}_ERA5']

ds_mod=ds_mod_var.copy(deep=True)
ds_mod[f'{var}_hist']=ds_mod_var[f'{var}_hist']-ds_mod_mean[f'{var_mean}_hist']
ds_mod[f'{var}_ssp126']=ds_mod_var[f'{var}_ssp126']-ds_mod_mean[f'{var_mean}_ssp126']
ds_mod[f'{var}_ssp370']=ds_mod_var[f'{var}_ssp370']-ds_mod_mean[f'{var_mean}_ssp370']
