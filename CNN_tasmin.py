"""
This script performs CNN-based regridding of CMIP6 minimum temperature outputs.
...
var='tasmin' # minimum temperature

######################## CNN training ########################################

# MATLAB v7.3 (HDF5-based) dataset containing ERA5 paired inputs and targets 
# (delta between minimum and mean temperature)
...
for mod_name in mod_names:
    ...
    var_hist=ds_GCM_mean[f'{var_mean}_hist']-ds_GCM_var[f'{var}_hist']
    ...
    X_ssp126=ds_GCM_mean[f'{var_mean}_ssp126']-ds_GCM_var[f'{var}_ssp126']
    ...
    X_ssp370=ds_GCM_mean[f'{var_mean}_ssp370']-ds_GCM_var[f'{var}_ssp370']
